    ...
    return {
        'ClientLoginNetHandler Transformer': {
            ...
            'transformer': function (method) {
                ...
                insns.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "net/raphimc/openauthmod/OpenAuthMod", "getInstance", "()Lnet/raphimc/openauthmod/OpenAuthMod;"));
                ...
                insns.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/raphimc/openauthmod/OpenAuthMod", "handleLoginCustomPayload", "(Lnet/minecraft/network/Connection;Lnet/minecraft/resources/ResourceLocation;ILnet/minecraft/network/FriendlyByteBuf;)Z"));
        ...
        'ClientPlayNetHandler Transformer': {
            ...
            'transformer': function (method) {
                ...
                insns.add(new MethodInsnNode(Opcodes.INVOKEVIRTUAL, "net/raphimc/openauthmod/OpenAuthMod", "handlePlayCustomPayload", "(Lnet/minecraft/network/Connection;Lnet/minecraft/resources/ResourceLocation;Lnet/minecraft/network/FriendlyByteBuf;)Z"));
                insns.add(new JumpInsnNode(Opcodes.IFEQ, jumpAfterLabel));
                insns.add(new InsnNode(Opcodes.RETURN));
                insns.add(jumpAfterLabel);
